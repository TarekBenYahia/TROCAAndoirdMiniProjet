...
public class CommandesValidesClient extends AppCompatActivity {
    INodeJS myAPI;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.activity_commandes_valides_client);
        try {
        ...
        try {
            ...
            recyclerView = findViewById(R.id.my_recycler_view_commandeClValide);
            manager = new GridLayoutManager(CommandesValidesClient.this,2);
            ...
            call.enqueue(new Callback<List<CommandesNonValidés>>() {
                ...
                public void onResponse(Call<List<CommandesNonValidés>> call, Response<List<CommandesNonValidés>> response) {
                    try {
                        ...
                        mAdapter = new CommandesNClientValidesAdapter(CommandesValidesClient.this,myDataSet);
