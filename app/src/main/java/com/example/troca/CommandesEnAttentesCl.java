...
public class CommandesEnAttentesCl extends AppCompatActivity {
    INodeJS myAPI;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.activity_commandes_en_attentes_cl);
        try {
        ...
        try {
            ...
            Call<List<CommandesNonValidés>> call = myAPI.getCommandesClient(Integer.parseInt(idC));
            myDataSet = new ArrayList<>();
            recyclerView = findViewById(R.id.my_recycler_view_commandeCl);
            manager = new GridLayoutManager(CommandesEnAttentesCl.this, 2);
            ...
            call.enqueue(new Callback<List<CommandesNonValidés>>() {
                ...
                public void onResponse(Call<List<CommandesNonValidés>> call, Response<List<CommandesNonValidés>> response) {
                    try {
                        ...
                        mAdapter = new CommandesNClientAdapter(CommandesEnAttentesCl.this, myDataSet);
